...
/*Program Info for testingunit.cpp
    Purpose: To be able to do unit testing on all the sorting algorithms in the menu.cpp.

    Note: There are extra functions in here not related to the menu but were used for my own testing for Time Analysis
...
cout << "____________________________________________________________________________________________________" << endl;
cout << "\t\t\t\tBEFORE: Random Array" << endl; // 4 tabs
list1b.ShowArray();
cout << endl;
startTime = clock();
...
cout << "\t\t\t\tBEFORE: Shuffled Array" << endl;
list1b.ShowArray();
startTime = clock();
list1b.InsertionSort();
endTime = clock();
timeTaken = (endTime - startTime) / static_cast<double>(CLOCKS_PER_SEC);
cout << "\t\t\t\tAFTER: Shuffled Array" << endl;
...
cout << "\t\t\t\tBEFORE: Reversed Array" << endl;
list1b.ShowArray();
startTime = clock();
list1b.InsertionSort();
endTime = clock();
timeTaken = (endTime - startTime) / static_cast<double>(CLOCKS_PER_SEC);
cout << "\t\t\t\tAFTER: Reversed Array" << endl;
