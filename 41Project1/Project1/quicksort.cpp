...
/*Program Info for quicksort.cpp
...
class QuickSortClass{
    public:
            QuickSortClass(int n); // Constructor 
            ~QuickSortClass(); // Deconstuctor
        void SetRandomArray(); // Set random array of n values
        void SetShuffledArray(); // Set sorted array, then shuffle 10% of its values
        void SetSortedArray(); // Set sorted array
        void ShowArray(); // Display current state of the array
